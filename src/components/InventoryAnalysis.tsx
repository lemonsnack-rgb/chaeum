    ...
    return (
      <section className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-bold text-gray-900">냉장고 분석</h3>
        </div>
    ...
    <section className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
      <div className="flex items-center justify-between mb-4 gap-2">
        <div className="flex items-center gap-2 min-w-0 flex-1">
          ...
          <h3 className="text-lg font-bold text-gray-900 flex-shrink-0">냉장고 분석</h3>
          {needsUpdate && (
            <span className="px-2 py-0.5 bg-orange-100 text-orange-600 text-xs rounded-full font-medium animate-pulse whitespace-nowrap">
              갱신필요
            </span>
          )}
        </div>
        <button
          onClick={onAnalyze}
          disabled={analyzing}
          className={`px-3 py-2 rounded-xl text-sm font-semibold transition-all flex items-center gap-1.5 shadow-sm flex-shrink-0 ${
            needsUpdate
        ...
        >
          {analyzing ? (
            ...
            <>
              ...
              <span className="hidden sm:inline">{analysis ? '재분석' : '분석'}</span>
              <span className="sm:hidden">{analysis ? '재분석' : '분석'}</span>
            </>
          )}
        </button>
      </div>
